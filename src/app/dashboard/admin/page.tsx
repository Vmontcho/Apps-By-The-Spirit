      ...
      <nav className="bg-white shadow-lg fixed w-full z-50">
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <Link
                ...
                className="text-gray-600 hover:text-[#621B93] px-3 py-2 rounded-md text-sm font-medium"
              >
                Accueil
              </Link>
              <Link
            ...
            <div className="md:hidden flex items-center">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-[#621B93] hover:bg-gray-100 focus:outline-none"
              >
                <svg
                  className="h-6 w-6"
                  fill="none"
        ...
        <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden bg-white`}>
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link
              href="/dashboard/admin"
              className="text-gray-600 hover:text-[#621B93] block px-3 py-2 rounded-md text-base font-medium"
            >
              Accueil
            </Link>
            <Link
